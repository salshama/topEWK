...
from 2025jan_hist_plots import get_xlabel, get_selection, get_variation, get_process
...
outplot_dir = "/ceph/salshamaily/topEWK_FCCee/plots/deviation/2025jan_individual"
    ...
    for file in root_files:
        ...
        for key in f.GetListOfKeys():
            ...
            if isinstance(hist, ROOT.TH1):
                ...
                c2.Update()
                c2.SaveAs(os.path.join(outplot_dir, f"{variable}_{process}_{variation}_{selection}_devind.png"))
                c2.Draw()
